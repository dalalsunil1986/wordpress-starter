...
!function(e){"use strict";function t(){i?(o.text("Search"),h.hide(),i=!1):(o.text("Close"),h.show(),i=!0),a.toggleClass("search-visible"),i&&e('#header-search input[type="search"]').focus()}var a=e(".site-header"),h=e("#site-overlay"),o=(e("body"),e('a[href="#search"]')),i=!1;e(window).load(function(){e(".logic-code").parent().addClass("stretch")}),e(".home-page-intro a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=e(this.hash);if(t=t.length?t:e("[name="+this.hash.slice(1)+"]"),t.length)return e("html,body").animate({scrollTop:t.offset().top-a.height()},750),!1}}),o.add(h).click(function(e){e.preventDefault(),t()})}(jQuery);